file1 = '/home/mio/my-git-repos/Project_Scilifelab/results/groups/group2345.txt'
file2 = '/home/mio/Desktop/svm_light/outfile2345.out'

f1 = open(file1,'r')
fi_1 = f1.read().splitlines()
f2 = open(file2,'r')
fi_2 = f2.read().splitlines()
ev = open('evaluation2345.txt','w')
